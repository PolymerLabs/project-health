...
export type OrgReposQueryVariables = {
  login: string,
  cursor?: string | null,
};
...
export type RepoCommitsQueryVariables = {
  owner: string,
  name: string,
  cursor?: string | null,
  since?: string | null,
...
export type RepoPRsCommitsQueryVariables = {
  owner: string,
  name: string,
  cursor?: string | null,
};

export type RepoPRsCommitsQuery = {
  // Lookup a given repository by the owner and repository name.
  repository:  {
    __typename: "Repository",
...
export type PullRequestCommitsQueryVariables = {
  id: string,
  cursor?: string | null,
};
...
export type ViewerPullRequestsQueryVariables = {
  query: string,
};
